...
declare const createMarkdownRenderer: (
  srcDir: string,
...
type RawConfigExports<ThemeConfig = any> =
...
interface SiteConfig<ThemeConfig = any>
  extends Pick<
    UserConfig,
    | 'markdown'
    | 'vue'
...
type UserConfigExport<ThemeConfig> =
...
declare function resolveSiteData(
  root: string,
  userConfig?: UserConfig,
  command?: 'serve' | 'build',
  mode?: string
...
declare function createContentLoader<T = ContentData[]>(
  ...
  { includeSrc, render, excerpt: renderExcerpt, transform }?: ContentOptions<T>
): {
  watch: string | string[];
  load: () => Promise<T>;
};
