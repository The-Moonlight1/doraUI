    ...
    <div v-show="visible !== null ? visible : true" class="dx-tooltip-max-width">
      ...
      <div v-show="tooltipVisible" class="dx-tooltip-dx-page-content-warpper">
        <div
          ...
          :style="background ? { background, color: '#fff', borderColor: background, width } : { width }"
        >
          {{ title }}
        </div>
        ...
        <div class="tooltip-icon" :style="background ? { background, color: '#fff', borderColor: background } : {}" />
      </div>
    </div>
    <slot />
  </div>
